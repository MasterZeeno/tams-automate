...
async function loginAndScrape() {
    ...
    try {
        ...
        await page.context().grantPermissions(['geolocation'], { origin: process.env.HCC_BASE_URL || 'https://hcc-tams.com.ph' });
        ...
        // Perform login
        await page.fill('input[name="username"]', process.env.ZEE_USERNAME || '15913');
        await page.fill('input[name="password"]', process.env.ZEE_PASSWORD || '546609529');
